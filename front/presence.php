...
function header_presence_all($visibility, $header_all, $header_selected) {
  ...
  echo '<div class="'.$layout['lg'].' '.$layout['md'].' '.$layout['sm'].' '.$hide.'">
          ...
          <div class="small-box bg-aqua">
            <div class="inner" style="padding: 0px 10px;"><h3 id="devicesAll"> -- </h3><p class="infobox_label">'.$pia_lang['PRE_Shortcut_AllDevices'].'</p></div>
  ...
  echo '<div class="'.$layout['lg'].' '.$layout['md'].' '.$layout['sm'].' '.$hide.'">
          <a href="#" onclick="javascript: getDevicesPresence(\'connected\');">
            <div class="small-box bg-green">
              <div class="inner" style="padding: 0px 10px;"> <h3 id="devicesConnected"> -- </h3><p class="infobox_label">'.$pia_lang['PRE_Shortcut_Connected'].'</p></div>
  ...
  echo '<div class="'.$layout['lg'].' '.$layout['md'].' '.$layout['sm'].' '.$hide.'">
          <a href="#" onclick="javascript: getDevicesPresence(\'favorites\');">
            <div  class="small-box bg-yellow">
              <div class="inner" style="padding: 0px 10px;"> <h3 id="devicesFavorites"> -- </h3><p class="infobox_label">'.$pia_lang['PRE_Shortcut_Favorites'].'</p></div>
...
function header_presence_new($visibility, $header_all, $header_selected) {
  ...
  echo '<div class="'.$layout['lg'].' '.$layout['md'].' '.$layout['sm'].' '.$hide.'">
          <a href="#" onclick="javascript: getDevicesPresence(\'new\');">
            <div  class="small-box bg-yellow">
              <div class="inner" style="padding: 0px 10px;"> <h3 id="devicesNew"> -- </h3><p class="infobox_label">'.$pia_lang['PRE_Shortcut_NewDevices'].'</p></div>
  ...
  echo '<div class="'.$layout['lg'].' '.$layout['md'].' '.$layout['sm'].' '.$hide.'">
          <a href="#" onclick="javascript: getDevicesPresence(\'down\');">
            <div  class="small-box bg-red">
              <div class="inner" style="padding: 0px 10px;"> <h3 id="devicesDown"> -- </h3><p class="infobox_label">'.$pia_lang['PRE_Shortcut_DownAlerts'].'</p></div>
  ...
  echo '<div class="'.$layout['lg'].' '.$layout['md'].' '.$layout['sm'].' '.$hide.'">
          <a href="#" onclick="javascript: getDevicesPresence(\'archived\');">
            <div  class="small-box bg-gray top_small_box_gray_text">
              <div class="inner" style="padding: 0px 10px;"> <h3 id="devicesHidden"> -- </h3><p class="infobox_label">'.$pia_lang['PRE_Shortcut_Archived'].'</p></div>
