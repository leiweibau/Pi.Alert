...
$help_lang['Cat_General_107_text'] = 'Il file <span class="text-maroon help_faq_code">pialert.conf</span> si trova nella directory <span class="text-maroon help_faq_code">~/pialert/config</span>. In questo file di configurazione è possibile personalizzare molte funzionalità di Pi.Alert in base alle proprie preferenze. Poiché le opzioni sono varie, fornirò una breve spiegazione di ciascun punto.
									...
									<table class="help_table_gen">
                                    	...
                                    	<tr><td class="help_table_gen_a">REPORT_NEW_CONTINUOUS_CRON</td>
									        <td class="help_table_gen_b">ntervallo, nella sintassi di crontab, in cui i backup automatici dovrebbero essere creati. L&apos;intervallo più breve è di 3 minuti. Tutti gli intervalli più lunghi devono essere multipli interi di 3 minuti (15, 30, 36, ecc).</td></tr>
									...
									<table class="help_table_gen">
									    ...
									    <tr><td class="help_table_gen_a">PIHOLE6_URL</td>
										    <td class="help_table_gen_b">Se desideri accedere ai dati di Pi-hole versione 6, inserisci qui l&apos;URL dell&apos;interfaccia web (senza il suffisso "/admin").</td></tr>
									    ...
									    <tr><td class="help_table_gen_a">DHCP_INCL_SELF_TO_LEASES</td>
    										<td class="help_table_gen_b">Aggiunge gli indirizzi MAC di Pi-hole stesso ai lease DHCP per importare Pi-hole stesso nel database se non si trova sulla rete locale di Pi.Alert</td></tr>
									</table>
									<table class="help_table_gen">
